...
class BooklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create booklist" do
    assert_difference("Booklist.count") do
      post booklists_url, params: { booklist: { author: @booklist.author, available: @booklist.available, bookid: @booklist.bookid, publisher: @booklist.publisher, tilte: @booklist.tilte, type_id: @booklist.type_id, year: @booklist.year } }
    end
  ...
  test "should update booklist" do
    patch booklist_url(@booklist), params: { booklist: { author: @booklist.author, available: @booklist.available, bookid: @booklist.bookid, publisher: @booklist.publisher, tilte: @booklist.tilte, type_id: @booklist.type_id, year: @booklist.year } }
