...
class ProductcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create productcategory" do
    assert_difference("Productcategory.count") do
      post productcategories_url, params: { productcategory: { description: @productcategory.description, name: @productcategory.name } }
    end
  ...
  test "should update productcategory" do
    patch productcategory_url(@productcategory), params: { productcategory: { description: @productcategory.description, name: @productcategory.name } }
